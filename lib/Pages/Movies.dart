...
class _HomeScreenState extends State<Movies> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Center(child: const Text("Latest Movies", style: TextStyle(color: Colors.white, fontSize: 30) ,)),
